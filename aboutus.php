      ...
      <div class="row">
        ...
        <div class="animation-div col-md-10">
          ...
          <p>
            ...
            Let us guide you to success with solutions crafted for your unique needs.</p>
      ...
      <div class="row justify-content-center">
        ...
        <div class="box col-lg-4 col-md-6 mb-4">
          ...
          <div class="card bg-transparent border-0 h-100 text-white">
            ...
            <p class="text-muted">We focus on what truly matters to your users, avoiding unnecessary <br>complexity that could overwhelm them.</p>
        ...
        <div class="box col-lg-4 col-md-6 mb-4">
          ...
          <div class="card bg-transparent border-0 h-100 text-white">
            ...
            <h5 class="fw-bold">Practical solutions for real needs.</h5>

            <p class="text-muted">We create designs and functionalities that directly address your business goals and user expectations.</p>
