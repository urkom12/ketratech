...
<section class="quick-links container py-5">
    ...
    <div class="row">
        <div class="col-md-4 animated-link-mob">
            <a href="aboutus.html" class="animated-link">Learn more about us</a>
        </div>
        <div class="col-md-4 animated-link-mob" style="text-align: center;">
            <a href="services.html" class="animated-link">See our plans</a>
        </div>
        <div class="col-md-4 animated-link-mob"style="text-align: right;">
            <a href="careers.html" class="animated-link">Open positions</a>
        </div>
    </div>
</section>
